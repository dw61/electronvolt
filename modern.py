...
eV = e * V # electrovolt
keV = kilo * eV # kilo electrovolt
MeV = mega * eV # mega electrovolt
GeV = giga * eV # giga electrovolt
TeV = tera * eV # tetra electrovolt
MeVpc2 = MeV / c**2 # mega electrovolt per c squared
